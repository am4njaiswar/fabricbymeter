  ...
  return (
    <div className="font-sans bg-white"> {/* Use the same font-sans as your site */}
      <div className="max-w-4xl mx-auto py-12 px-6">
        ...
        {/* Breadcrumbs from image */}
        {/* --- CHANGE: Removed md:text-left --- */}
        ...
        <h1 className="text-3xl md:text-4xl font-bold uppercase text-gray-900 text-center mb-12">
        ...
        <div className="space-y-6 text-gray-700 text-sm md:text-base leading-relaxed">
          <p>
            This website is operated by The Fabric By Meter. Throughout the site,
            the terms “we”, “us” and “our” refer to The Fabric By Meter. The
            Fabric By Meter offers this website, including all information, tools
          ...
          <div className="space-y-4 pt-6">
            ...
            <p>
              ...
              are and shall be under no obligation (1) to maintain any comments
          ...
          <div className="space-y-4 pt-6">
            ...
            <p>
              In no case shall The Fabric By Meter, our directors, officers,
              ...
              in any way to your use of the service or any product, including,
          ...
          <div className="space-y-4 pt-6">
            ...
            <p>
              You agree to indemnify, defend and hold harmless The Fabric By
              Meter and our parent, subsidiaries, affiliates, partners, officers,
