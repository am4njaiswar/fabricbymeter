...
export default function Navbar() {
  ...
  const hrefMap: Record<(typeof menuItems)[number], string> = {
    "OUR STORY": "/ourstory",
    WHOLESALE: "/wholesale",
    CONTACT: "/contact",
    ...
    <header className="md:relative sticky top-0 z-50 bg-white border-b border-gray-200">
      <div className="flex items-center justify-between h-16 sm:h-20 px-4 sm:px-6 lg:px-10">
        ...
        <div className="flex-[2] flex justify-center">
          <Link
            href="/"
            className="text-4xl font-serif font-medium text-gray-800 inline-block transition-transform duration-300 hover:scale-105"
          >
            <Image
        ...
        <div className="flex items-center justify-end flex-1 space-x-3 sm:space-x-5">
          ...
          <a
            href="#"
            className="hidden items-center space-x-1 text-sm text-gray-700 font-sans md:flex hover:text-gray-900 transition-all duration-300 group"
          >
            <User
      ...
      <nav className="hidden items-center justify-center h-14 space-x-10 font-sans bg-white md:flex font-medium relative">
        <div className="relative flex items-center text-black">
          <Link
            href="/shop"
            className="text-sm tracking-widest uppercase py-2 transition-colors duration-300 hover:text-gray-600"
          >
            SHOP
          </Link>
          <button
      ...
      >
        <div className="container mx-auto px-6 py-8 h-full flex flex-col">
          ...
          >
            <h3 className="text-2xl text-gray-800 uppercase tracking-widest">
              BY CATEGORY
            </h3>
      ...
      <div
        className={`fixed top-16 sm:top-20 left-0 w-5/6 max-w-md bottom-0 bg-white md:hidden overflow-y-auto z-40 shadow-lg transition-all duration-700 ease-out ${
          isMenuOpen
      ...
      >
        <nav className="flex flex-col h-full">
          <div className="flex-1 overflow-y-auto">
            <div
              className={`border-b border-gray-300 mx-6 transition-all duration-700 ${
                isMenuOpen
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 -translate-y-4"
              }`}
            ...
            >
              <div className="flex items-center justify-between w-full text-black py-4">
                <Link
                  href="/shop"
                  className="flex-1 text-left text-base font-medium tracking-widest uppercase text-black hover:text-gray-600 transition-colors duration-300"
                >
                  SHOP
                </Link>
                <button
                ...
                {fabricCategories.map((category, index) => (
                  <div key={index}>
                    <button
                      ...
                      style={{
                        transitionDelay: mobileShopOpen
                          ? `${index * 60}ms`
                          : "0ms",
                      }}
                      onClick={() =>
                    ...
                    <div
                      className={`bg-white border-l-2 border-gray-800 overflow-hidden transition-all duration-500 ease-out ${
            ...
            <div
              className={`flex items-center justify-center border-b border-gray-300 mx-6 transition-all duration-700 ${
                isMenuOpen
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 -translate-y-4"
              }`}
          ...
          <div
            className={`border-t-2 border-gray-400 bg-white transition-all duration-700 ${
              isMenuOpen
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-4"
            }`}
